package ru.company.jcore.JC1.views;
...
public class Conole {
    ...
    double weight = userInput("Введите Ваш вес в кг (например 60.2): ", scan);
    dataList.add(weight);

    double height = userInput("Введите Ваш рост в метрах (например 1.90): ", scan);
    dataList.add(height);
